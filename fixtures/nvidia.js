export const nvidiaFixture = {
  ...
  modelInputs: {
    ...
    componentsByKey: {
      kpiDataHistory: { name: "KPI data history", score: 92, maturity: "high", status: "High" },
      kpiMethodology: { name: "KPI methodology", score: 90, maturity: "high", status: "High" },
      reportingInfrastructure: { name: "Reporting infrastructure", score: 88, maturity: "high", status: "High" },
      externalVerification: { name: "External verification", score: 88, maturity: "high", status: "High" },
      strategicAlignment: { name: "Strategic alignment", score: 84, maturity: "high", status: "High" },
    },
  },
  analysis: {
    kpis: [
      {
        ...
        evidence: "100% renewable electricity in FY25; FY23 44%, FY24 76%, FY25 100%; external assurance for select metrics.",
        status: "Ready",
      },
      {
        name: "GHG emissions intensity",
        evidence: "Scope 1 and 2 emissions intensity improved from 2.6 to 0.9 to 0.1 mtCO2e/$M revenue across FY23-FY25.",
        status: "Ready",
      },
      {
        name: "Science-based Scope 1 and 2 reduction",
        evidence: "SBTi validated target from FY23 base year: reduce absolute Scope 1 and 2 emissions 50% by FY30.",
        status: "Ready",
      },
      {
        name: "Scope 3 product-use emissions intensity",
        evidence: "SBTi validated target: reduce Scope 3 emissions intensity from use of sold GPU products by 75% per PFLOP by FY30.",
        status: "Partial",
      },
    ],
    gaps: [
