...
const chunkEvidenceContract = {
  ...
  evidence: [
    {
      topic: "KPI | target | methodology | reporting | verification | strategy | gap | investment | capex | green_project | carbon_credit | offset",
...
export function buildChunkEvidencePrompt({ text, metadata }) {
  return [
    ...
    "Also extract sustainability investment evidence where explicit investment, capex, project, fund, renewable energy procurement, offset or carbon credit activity is mentioned.",
...
export function buildFinalMergePrompt({ metadata, evidences }) {
  return [
    ...
    "Create analysis.sustainabilityInvestments from cited investment/capex/project/carbon-credit evidence only. If none exists, return an empty items array and No cited investment evidence.",
    "For each sustainability investment, assess what was invested in, whether it is good enough to support a green-finance/carbon-credit conversation, and whether it creates direct credit supply, residual-credit demand, or no clear carbon-credit pathway.",
  ...
  analysis: {
    ...
    sustainabilityInvestments: {
      ...
      items: [
        {
          name: "string",
          category: "renewable_energy | energy_efficiency | clean_transport | green_buildings | supplier_decarbonization | sustainable_finance | nature_based | carbon_removal | waste_methane | water | circularity | other",
          ...
          assessment: "string",
          citations: [{ quote: "string", pages: ["number"] }],
        },
      ],
    },
